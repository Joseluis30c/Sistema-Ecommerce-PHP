...
class pdf extends FPDF
{
	public function header()
	{
		...
		$this->Write(15, utf8_decode('Reporte de Usuarios'));
		$this->Ln();
	}
...
$fpdf->SetTitle('Reporte de Usuarios',true);
$fpdf->AliasNbPages();
$fpdf->AddPage();
...
$sql = "SELECT * FROM usu_empleado e INNER JOIN tipo_usuario t on e.id_tipousu=t.id_tipousu";
$resultado = mysqli_query($con,$sql);
	while ($fila = $resultado->fetch_assoc()) {
		$fpdf->Cell(5, 10, $fila['id_usu_emple'], 0, 0, 'C', 1);
		$fpdf->Cell(25, 10,utf8_decode($fila['nombre_emple']), 0, 0, 'C',1);
		$fpdf->Cell(25, 10,utf8_decode($fila['apellido_emple']), 0, 0, 'C',1);
		$fpdf->Cell(20, 10,$fila['dni_emple'], 0, 0, 'C',1);
		$fpdf->Cell(20, 10,$fila['telefono_emple'], 0, 0, 'C',1);
		$fpdf->Cell(40, 10,utf8_decode($fila['usuario']), 0, 0, 'C',1);
		$fpdf->Cell(30, 10,utf8_decode($fila['contra']), 0, 0, 'C',1);
		$fpdf->Cell(30, 10,utf8_decode($fila['nombre_usu']), 0, 0, 'C',1);
		$fpdf->Ln();
	}

$fpdf->OutPut('I','Reporte_usuarios.pdf');