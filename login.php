...
if(!empty($_SESSION['active'])){
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['txtusuario']) || empty($_POST['txtpassword'])) {
            ...
            $consulta=mysqli_query($con,"SELECT * FROM usu_cliente WHERE usuario='$user' AND contra='$clave'");
            ...
            if ($resultado>0) {
                ...
                $_SESSION['id'] =$data['id_usu_cli'];
                $_SESSION['nomb']=$data['nombre_cli'];
                $_SESSION['ape']=$data['apellido_cli'];
                $_SESSION['dni']=$data['dni_cli'];
                $_SESSION['tel']=$data['telefono_cli'];
                $_SESSION['dir']=$data['direccion_cli'];
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          ...
          <div class="text-center text-lg-start"><br>
            <button type="submit" class="btn btn-primary btn-lg"
              ...
              <p class="small fw-bold mt-2 pt-1 mb-0"> you do not have an account?<a href="registrarcli.php"
